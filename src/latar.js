...
const KATA_LATAR = [
  /* Level 3 Scene 3 - Foto Viral & Pesan Teman */
  [/\b(Foto (Reyan|Rafa|Alya|Mika|\{NAMA\})?.*telah disebarkan|Foto tersebut sudah diunggah ulang|ini yang kemarin viral|Sebarin lagi|Semua orang bisa lihat foto ini)\b/i, 'cg_l9_viral'],
  [/\b(pesan dari seseorang yang ia percaya|postingannya\. Kamu nggak apa-apa|terdiam cukup lama|terlalu fokus menghadapi komentar tersebut sendirian)\b/i, 'cg_l9_pesan_teman'],

  /* Level 3 Scene 2 - Cyberbullying Notifikasi Beruntun */
  [/\b(TING!|notifikasi terus berdatangan|kembali mengambil HP)\b/i, 'cg_l8_notif_ting'],
  [/\b(Keesokan harinya.*?kembali membuka media sosial|Masih belum dihapus juga|serangan beramai-ramai|sasaran banyak orang)\b/i, 'cg_l8_notif'],

  /* Level 3 Scene 1 - Cyberbullying Media Sosial */
  ...
  [/\b(Setelah berhasil melewati berbagai ejekan verbal di sekolah|Awalnya permainan berlangsung|sembilan!|sengaja mendorong)\b/i, 'cg_l4_taman'],
  [/\b(memilih tidak membalas( perlakuan teman-temannya)?\. Ia hanya (menundukkan kepala|memeluk lututnya))\b/i, 'cg_l4_taman_diam'],
  [/\b(membalas dorongan yang diterimanya|merasa marah karena terus didorong)\b/i, 'cg_l4_taman_marah'],
  [/\b((memutuskan|memilih) meninggalkan permainan|berjalan (menjauh )?menuju bangku taman)\b/i, 'cg_l4_taman_pergi'],
  [/\b((menghampiri|mencari bantuan kepada) orang dewasa yang( sedang)? berada di taman)\b/i, 'cg_l4_taman_lapor'],
  [/\b(Bola mengenai tepat di bahu|Strike! Mantapkan\?|Keren, Bro! Udah kayak nembak pin bowling|memegang bahunya yang sakit)\b/i, 'cg_l5_bola_kena'],
  [/\b(mencoba menjauh dan duduk di bangku taman|Mereka mengambil bola yang ada di lapangan|Woy, liat tuh\. Ada papan target|Hati-hati loh, ntar kena mukanya)\b/i, 'cg_l5_bola'],
  [/\b(memilih menarik napas panjang dan tidak membalas|tetap diam meskipun ejekan masih terdengar)\b/i, 'cg_l5_bola_diam'],
  [/\b(mengambil bola yang mengenai tubuhnya|suasana berubah menjadi keributan|Cukup! Rasain juga!|Berani banget kamu|Ayo balas dia|saling melempar bola)\b/i, 'cg_l5_bola_marah'],
  [/\b(memilih mendekati sahabatnya|memilih mencari sahabatnya|Temannya langsung berdiri di samping|Aku temenin kamu|Jangan ganggu .* terus)\b/i, 'cg_l5_bola_pergi'],
  [/\b(segera menghampiri ayah salah satu temannya|menghampiri seorang ayah|mendatangi anak-anak yang melakukan bullying|datang meminta bantuan|langsung menghampiri para pelaku)\b/i, 'cg_l5_bola_lapor'],
  [/\b(didorong dan dilempar bola|mendorong, memukul, dan menendangnya|Rasain nih|Tendang lebih keras|Berhenti ganggu aku!|baru gitu aja udah ngeluh|mulai merasa takut, marah, dan tertekan|mulai berpikir apa yang harus ia lakukan)\b/i, 'cg_l6_tendang'],
  [/\b(merasa sangat marah setelah didorong dan ditendang|sadar bahwa membalas dengan kekerasan mungkin)\b/i, 'cg_l6_tendang_diam'],
  [/\b(tidak tahan lagi, ia berdiri dan mendorong|Situasi berubah menjadi perkelahian|Kekerasan justru membuat masalah)\b/i, 'cg_l6_tendang_marah'],
  [/\b(memilih untuk tidak menghadapi mereka sendirian|berjalan mencari seseorang yang benar-benar|Di kejauhan, ia melihat teman baiknya)\b/i, 'cg_l6_tendang_pergi'],
  [/\b(boleh cerita sesuatu|kelihatan takut|mereka mulai dorong dan nendang aku|nemenin kamu)\b/i, 'cg_l6_tendang_teman'],
  [/\b(memilih meninggalkan taman dan segera pulang)\b/i, 'cg_l6_tendang_lapor'],
  [/\b(diganggu sama temen-temen|Kamu sampai jatuh\? Ada yang sakit\?|ibu berpelukan hangat)\b/i, 'cg_l6_tendang_ibu'],
