...
const KATA_LATAR = [
  ...
  [/\b(mengambil bola yang mengenai tubuhnya|suasana berubah menjadi keributan)\b/i, 'cg_l5_bola_marah'],
  [/\b(memilih mendekati sahabatnya|Temannya langsung berdiri di samping)\b/i, 'cg_l5_bola_pergi'],
  [/\b(segera menghampiri ayah salah satu temannya|mendatangi anak-anak yang melakukan bullying)\b/i, 'cg_l5_bola_lapor'],
